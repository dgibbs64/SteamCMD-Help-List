...
echo "================================="
steamcmd +login anonymous +help +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help.txt"
...
echo "================================="
steamcmd +login anonymous +help login +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help_login.txt"
...
echo "================================="
steamcmd +login anonymous +help scripts +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help_scripts.txt"
...
echo "================================="
steamcmd +login anonymous +help commandline +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help_commandline.txt"
...
echo "================================="
steamcmd +login anonymous +help convars +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help_convars.txt"
...
echo "================================="
steamcmd +login anonymous +help app_build +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help_app_build.txt"
...
echo "================================="
steamcmd +login anonymous +help app_update +quit | grep -v "Waiting for user info" | grep -v "Unloading Steam API...OK" | tee "${rootdir}/steamcmd_help_app_update.txt"
